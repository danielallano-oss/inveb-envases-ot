...
import type { UserDetail, UserCreate, UserUpdate, RoleOption, WorkSpaceOption } from '../../services/api';
...
export default function UserForm({
  ...
  const [formData, setFormData] = useState({
    ...
    work_space_id: user?.work_space_id || null,
  });
  ...
  const handleChange = useCallback((e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    setFormData(prev => ({
      ...prev,
      [name]: ['role_id', 'work_space_id'].includes(name)
  ...
  const handleSubmit = useCallback((e: React.FormEvent) => {
    ...
    if (isEditing) {
      const submitData: UserUpdate = {
        ...
        work_space_id: formData.work_space_id || undefined,
      };
      onSubmit(submitData);
    } else {
