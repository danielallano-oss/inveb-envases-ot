$(document).ready(function () {
    //console.log("PRUEBA AREA HC VALIDATION");
    ...
    $("#formAreaHC")
        ...
        .validate({
            ...
            rules: {
                ...
                envase_id: "required",
                rubro_id: "required",
                contenido_caja: "required",
                pallets_apilados: "required",
                cajas_apiladas_por_pallet: "required",
                filas_columnares_por_pallet: "required",
                carton_color: "required",
                ect_min_ingresado: "required",
                prepicado_ventilacion: "required",
            },
    ...
    $("#formAreaHC").on("change", "select", function (e) {
