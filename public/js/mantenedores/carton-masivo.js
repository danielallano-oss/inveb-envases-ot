$(document).ready(function () {
    ...
    $("#form-carga-cartones").on("submit", function (e) {
        ...
        return $.ajax({
            type: "POST",
            url: "/mantenedores/cotizador/cartons/uploading",
            data: formulario,
            processData: false,
            contentType: false,
            cache: false,
            success: function (data) {
                ...
                <td>${carton.onda}</td>
                <td>${carton.peso}</td>
                <td>${carton.espesor}</td>
                <td>${carton.color_tapa_exterior}</td>
                <td>${carton.tipo}</td>
                <td>${carton.codigo_tapa_interior != '0' &&
                                carton.codigo_tapa_interior != ""
                                ? carton.codigo_tapa_interior
                                : ""
                            }</td>
                <td>${carton.codigo_onda_1 != '0' && carton.codigo_onda_1 != ""
                                ? carton.codigo_onda_1
                                : ""
                            }</td>
                <td>${carton.codigo_onda_1_2 != '0' && carton.codigo_onda_1_2 != ""
                                ? carton.codigo_onda_1_2
                                : ""
                            }</td>
                <td>${carton.codigo_tapa_media != '0' &&
                                carton.codigo_tapa_media != ""
                                ? carton.codigo_tapa_media
                                : ""
                            }</td>
                <td>${carton.codigo_onda_2 != '0' && carton.codigo_onda_2 != ""
                                ? carton.codigo_onda_2
                                : ""
                            }</td>
                <td>${carton.codigo_tapa_exterior != '0' &&
                                carton.codigo_tapa_exterior != ""
                                ? carton.codigo_tapa_exterior
                                : ""
                            }</td>
                <td>${carton.alta_grafica == 1 ? "SI" : "NO"}</td>
                <td>${carton.provisional == 1 ? "SI" : "NO"}</td>
               ...
               <td  colspan="14">Cartones con Errores</td>
               </tr>`;
               ...
               <td colspan="11">${carton.motivos}</td>
