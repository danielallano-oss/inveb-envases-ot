$(document).ready(function () {
    ...
    var cuhillasMask = IMask(cuchillas, cuatroDecimalsOptions);
    // -------- JERARQUIAS ------------------
        ...
        $("#impresion")
            .change(() => {
                ...
                if ($("#impresion").val() != '') {
                    ...
                    $("#cinta,#cinta_text,#coverage_internal_id,#coverage_internal_id_text,#coverage_external_id,#coverage_external_id_text,#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text,#planta_original_sec_ope,#planta_aux_1_sec_ope,#planta_aux_2_sec_ope")
                        .prop("disabled", true)
                        .val("")
                        .selectpicker("refresh")
                        .closest("div.form-group")
                    ...
                    $("#fsc,#cinta,#cinta_text,#coverage_internal_id,#coverage_internal_id_text,#coverage_external_id,#coverage_external_id_text,#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text")
                        ...
                        .closest("div.form-group")
                        .removeClass("error");
                    $("#fsc,#cinta,#cinta_text,#coverage_internal_id,#coverage_internal_id_text,#coverage_external_id,#coverage_external_id_text,#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text,#planta_original_sec_ope,#planta_aux_1_sec_ope,#planta_aux_2_sec_ope")
                        .prop("disabled", true)
                        .val("")
                        .selectpicker("refresh")
                        .closest("div.form-group")
                ...
                if ($("#fsc").val() != '') {
                    ...
                    if (!!clean_options.length) {
                        ...
                        $("#coverage_internal_id,#coverage_internal_id_text,#coverage_external_id,#coverage_external_id_text,#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text")
                            ...
                            .closest("div.form-group")
                            .removeClass("error");
                        $("#coverage_internal_id,#coverage_internal_id_text,#coverage_external_id,#coverage_external_id_text,#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text,#planta_original_sec_ope,#planta_aux_1_sec_ope,#planta_aux_2_sec_ope")
                            .prop("disabled", true)
                            .val("")
                            .selectpicker("refresh")
                            .closest("div.form-group")
                ...
                if ($("#cinta").val() != '') {
                    ...
                    if (!!clean_options.length) {
                        ...
                        $("#coverage_external_id,#coverage_external_id_text,#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text")
                            ...
                            .closest("div.form-group")
                            .removeClass("error");
                        $("#coverage_external_id,#coverage_external_id_text,#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text,#planta_original_sec_ope,#planta_aux_1_sec_ope,#planta_aux_2_sec_ope")
                            .prop("disabled", true)
                            .val("")
                            .selectpicker("refresh")
                            .closest("div.form-group")
                        ...
                        if (tipo_solicitud == 3 && (role == 4 || role == 19 || (role == 8 && tipo == 'create'))) {
                ...
                if ($("#coverage_internal_id").val() != '') {
                    ...
                    if (!!clean_options.length) {
                        ...
                        $("#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text")
                            ...
                            .closest("div.form-group")
                            .removeClass("error");
                        $("#planta_id,#planta_id_text,#carton_color,#carton_color_text,#carton_id,#carton_id_text,#planta_original_sec_ope,#planta_aux_1_sec_ope,#planta_aux_2_sec_ope")
                            .prop("disabled", true)
                            .val("")
                            .selectpicker("refresh")
                            .closest("div.form-group")
            ...
            .change(async () => {
                ...
                if ($("#carton_color").val() != '') {
                    ...
                    if (!!clean_options.length) {
                        ...
                        console.log(role);
                        if ($('#tipo_solicitud_select_ppal').val() == 1 || $('#tipo_solicitud_select_ppal').val() == 7) {
                            console.log(role);
                            if (role == 6 || role == 18) {
                                $("#carton_id,#carton_id_combinabilidad,#carton_id_mckee").html(
                                    clean_options.toString()
            ...
            if (numeroColores === "0" || numeroColores === "") {
                ...
                switch (numeroColores) {
                    case "1":
                        ...
                        if ($("#coverage_external_id").val() != 4) {
                            desabilitarColores(
                                "#color_2_id,#impresion_2,#color_3_id,#impresion_3,#color_4_id,#impresion_4,#color_5_id,#impresion_5,#color_6_id,#impresion_6,#barniz_uv,#porcentanje_barniz_uv,#cm2_clisse_color_2,#cm2_clisse_color_3,#cm2_clisse_color_4,#cm2_clisse_color_5,#cm2_clisse_color_6,#cm2_clisse_color_7"
                            );
                            if (role != 3 && role != 4 && role != 5 && role != 6 && role != 18 && role != 19 && (role != 8 && tipo != 'create')) {
                    ...
                    case "2":
                        if ($("#coverage_external_id").val() != 4) {
                            desabilitarColores(
                                "#color_3_id,#impresion_3,#color_4_id,#impresion_4,#color_5_id,#impresion_5,#color_6_id,#impresion_6,#barniz_uv,#porcentanje_barniz_uv,#cm2_clisse_color_3,#cm2_clisse_color_4,#cm2_clisse_color_5,#cm2_clisse_color_6,#cm2_clisse_color_7"
                            );
                            if (role != 3 && role != 4 && role != 5 && role != 6 && role != 18 && role != 19 && (role != 8 && tipo != 'create')) {
                    ...
                    case "3":
                        if ($("#coverage_external_id").val() != 4) {
                            desabilitarColores(
                                "#color_4_id,#impresion_4,#color_5_id,#impresion_5,#color_6_id,#impresion_6,#barniz_uv,#porcentanje_barniz_uv,#cm2_clisse_color_4,#cm2_clisse_color_5,#cm2_clisse_color_6,#cm2_clisse_color_7"
                            );
                            if (role != 3 && role != 4 && role != 5 && role != 6 && role != 18 && role != 19 && (role != 8 && tipo != 'create')) {
                                $(
                    ...
                    case "4":
                        if ($("#coverage_external_id").val() != 4) {
                            desabilitarColores("#color_5_id,#impresion_5,#color_6_id,#impresion_6,#barniz_uv,#porcentanje_barniz_uv,#cm2_clisse_color_5,#cm2_clisse_color_6,#cm2_clisse_color_7");
                            if (role != 3 && role != 4 && role != 5 && role != 6 && role != 18 && role != 19 && (role != 8 && tipo != 'create')) {
                                $(
    ...
    if (tipo_solicitud == 1 || tipo_solicitud == 5 || tipo_solicitud == 7) {
    ...
    const cleanCheckboxs = () => {
        ...
        if (role == 4 || role == 3 || role == 19 || role == 6 || role == 7 || role == 8 || role == 5) {
    ...
    function getSecuenciasOperacionales(planta_id) {
        return $.ajax({
            type: "GET",
...
$("#button_cerrar_caracteristica").click(function () {
    $('#check_c,#check_e,#check_h,#check_i,#check_l,#check_n,#check_q,#check_r,#check_t,#check_y,#check_x,#check_p')
        .prop("checked", false);
});
