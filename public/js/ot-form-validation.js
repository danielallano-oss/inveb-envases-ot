$(document).ready(function () {
    ...
    const instalacionCliente = () => {
        if (role == 4) {
            ...
            if (realOptions.length === 0) {
                $("#instalacion_cliente").closest("div.form-group")
                    .removeClass("error");
                return false;
            } else {
                return true;
    ...
    const validacionRestriccionPallet = () => {
        ...
        if ($("#restriccion_pallet").val() == 1 && (role == 4 || role == 3 || role == 19)) {
            return true;
    ...
    $("#form-ot")
        ...
        .validate({
            ...
            rules: {
                ...
                carton_id: {
                    required: function () {
                        return (tipo_solicitud.val() == 3 || tipo_solicitud.val() == 5) && (role == 4 || role == 19)
                    },
                    // required: muestra,
                },
                carton_color: {
                ...
                coverage_internal_id: {
                    required: function () {
                        ...
                        // );
                        return (role == 4 || role == 19) && tipo_solicitud.val() != 3;
                    },
                },
                ...
                color_interno: {
                    required: function () {
                        ...
                        if (parseInt(role) === 8 && parseInt($("#impresion").val()) === 4 && tipo != 'create') {
                            return true;
                        }
                ...
                barniz_uv: {
                    required: function () {
                        ...
                        if (parseInt(role) === 8 && parseInt($("#coverage_external_id").val()) === 4 && tipo != 'create') {
                            return true;
                        } else {
                            return false;
                        }
