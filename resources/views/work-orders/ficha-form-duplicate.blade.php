			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-4">
						...
						@else
							<!-- Tipo de Solicitud -->
							{!! inputReadOnly('Tipo de Solicitud', [1 => "Desarrollo Completo", 4 => "Cotiza sin CAD", 2 => "Cotiza con CAD", 3 => "Muestra con CAD", 7 => "OT Proyectos Innovación", 5 => "Arte con Material", 6 => "Otras Solicitudes Desarrollo"][$ot->tipo_solicitud]) !!}
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-3">
                        ...
                        {!! armarSelectArrayCreateEditOT($trazabilidad, 'trazabilidad', 'Trazabilidad', $errors, $ot ,'form-control',true,false) !!}
