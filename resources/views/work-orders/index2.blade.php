...
<form id="filtros" class="py-3" action="{{ route('home2') }}" method="get" enctype="multipart/form-data">
	<div class="form-row ">
		<div class="col-1">
		...
		<tbody>
			...
			@endif
				...
				<td class="border">
					...
					{!! $ot->present()->tiempoTotal2() !!}
				</td>
				<td class="border">
					{!! $ot->present()->tiempoVenta2() !!}
				</td>
				<td class="border">
					{!!$ot->present()->tiempoDesarrollo2()!!}
				</td>
				<td class="border">
					{!!$ot->present()->tiempoMuestra2()!!}
				</td>
				<td class="border">
					{!!$ot->present()->tiempoDiseño2()!!}
				</td>
				<td class="border">
					{!!$ot->present()->tiempoDisenadorExterno2()!!}
				</td>
				<td class="border">
					{!!$ot->present()->tiempoPrecatalogacion2()!!}
				</td>
				<td class="border">
					{!!$ot->present()->tiempoCatalogacion2()!!}
				</td>
