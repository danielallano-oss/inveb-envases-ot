  ...
  <table id="listadoCartonesMasivos" class="table table-status table-hover text-center">
    ...
    <tbody>
      ...
      <tr id="carton-row-{{ $carton->orden }}" class="{{ $carton->active == 1 ? '' : 'text-muted' }}">
        ...
        <td>{{ $carton->tipo }}</td>
        <td>{{ $carton->codigo_tapa_interior != 0 && $carton->codigo_tapa_interior != "" ? $carton->codigo_tapa_interior : "" }}</td>
        <td>{{ $carton->codigo_onda_1  != 0 && $carton->codigo_onda_1 != "" ? $carton->codigo_onda_1 : ""  }}</td>
        <td>{{ $carton->codigo_onda_1_2  != 0 && $carton->codigo_onda_1_2 != "" ? $carton->codigo_onda_1_2 : ""  }}</td>
        <td>{{ $carton->codigo_tapa_media  != 0 && $carton->codigo_tapa_media != "" ? $carton->codigo_tapa_media : ""  }}</td>
        <td>{{ $carton->codigo_onda_2  != 0 && $carton->codigo_onda_2 != "" ? $carton->codigo_onda_2 : ""  }}</td>
        <td>{{ $carton->codigo_tapa_exterior  != 0 && $carton->codigo_tapa_exterior != "" ? $carton->codigo_tapa_exterior : ""  }}</td>
        <td>
