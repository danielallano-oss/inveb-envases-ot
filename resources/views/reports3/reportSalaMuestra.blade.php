...
<div class="container-fluid">
  <h1 class="page-title">Sala de Muestras</h1>
</div>
...
{{-- Filtro de búsqueda --}}
<div class="container-fluid">
  <form id="filtroReporte" class="filter-form py-1" action="{{ route('reportSalaMuestraNew1') }}" method="get" enctype="multipart/form-data">
    <div class="form-row">
      <div class="col-2">
