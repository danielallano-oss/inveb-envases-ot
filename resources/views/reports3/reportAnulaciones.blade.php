...
<div class="container-fluid">
  <h1 class="page-title">Anulaciones</h1>
</div>
...
<div class="container-fluid">
  <form id="filtroReporte" class="filter-form py-1" action="{{ route('reportAnulacionesNew1') }}" method="get" enctype="multipart/form-data">
    <div class="form-row">
      <div class="col-2">
