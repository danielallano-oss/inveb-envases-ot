...
<div class="row mb-3">
	<div class="col-12 p-2">
		<section id="ficha" class="py-3">
			<!-- formulario: -->
			<form onsubmit="$(this).find('input,select,textarea').prop('disabled', false)" id="form-ot" method="POST" action="{{ route('updateOt', $ot->id) }}" enctype="multipart/form-data">
				@method('PUT')
				@csrf
				...
				<input type="hidden" id="material_id" value="{{$ot->material_id ? $ot->material_id: null}}">
				<?php /*
...
<div class="modal fade" id="modal-log-mckee">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			<div class="modal-header text-center">
				<div class="title">Log Detalle Formula Mckee</div>
			</div>
			<div class="modal-body">
				<table class="table table-status table-hover" id="tabla_log_mckee" name="tabla_log_mckee">
					<thead>
						<tr>
							<th>Carton</th>
							<th>Largo</th>
...
<script src="{{ asset('js/ot-old-vertion/ot-edition.js') }}"></script>
<script>
	window.ot = @json($ot);
