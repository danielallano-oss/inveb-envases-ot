<div class="form-row">
				...
				<div class="row">
					...
					@if(Auth()->user()->isVendedorExterno())
						...
						<div class="col-4">
							...
							@else
								<!-- Tipo de Solicitud -->
								{!! inputReadOnly('Tipo de Solicitud', [1 => "Desarrollo Completo", 2 => "Cotiza con CAD", 3 => "Muestra con CAD", 4 => "Cotiza sin CAD", 5 => "Arte con Material", 6 => "Ficha Técnica", 7 => "Estudio Benchmarking"][$ot->tipo_solicitud] ?? 'N/A') !!}
 ...
 {{-- VB BOCE --}}
				...
				<div class="row">
					<div class="col-4">
						...
						<div class="matriz_select_container">
							{!! armarSelectArrayCreateEditOT($matrices, 'matriz_id', 'Matriz ',$errors, $ot, 'form-control form-element', true,true) !!}
						</div>
					...
					<div class="col-4">
						...
						<div class="form-group form-row ">
							...
							<div class="col-12 col-termocontraible">
								<!-- Termocontraible -->
	...
	<div id="ot-secuencia operacional" class="col-12 mb-2" >
		<div class="card h-100">
			<div class="card-header">11.- Secuencia Operacional</div>
			<div class="card-body">
				<div class="form-row">
	...
	<div id="ot-material" class="col-12 mb-2">
		<div class="card h-100">
			<div class="card-header">12.- Material Asignado</div>
			<div class="card-body">
