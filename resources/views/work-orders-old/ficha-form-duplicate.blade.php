<div class="form-row">
	...
	@if((auth()->user()->role_id == 5 || auth()->user()->role_id == 6) && ($tipo == "create" || $tipo == "duplicate"))
				...
				<div class="row">
					...
					<div class="col-4">
						...
						@elseif(Auth()->user()->isSuperAdministrador())
							...
							<!-- Contactos Cliente -->
							<!-- //style="display:none" -->
							{!! armarSelectArrayCreateEditOT([], 'instalacion_cliente',$ot->instalacion_cliente.' Instalación Cliente' , $errors, $ot ,'form-control form-element',true,true) !!}
							{!! armarSelectArrayCreateEditOT([], 'contactos_cliente', 'Contactos Cliente' , $errors, $ot ,'form-control form-element',true,true) !!}
						@else
							<!-- Tipo de Solicitud -->
							{!! inputReadOnly('Tipo de Solicitud', [1 => "Desarrollo Completo", 4 => "Cotiza sin CAD", 2 => "Cotiza con CAD", 3 => "Muestra con CAD", 5 => "Arte con Material"][$ot->tipo_solicitud]) !!}
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
                    ...
                    <div id="col-referencia1" class="col-6 hidden">
						<!-- Referencia -->
						{!! armarSelectArrayCreateEditOTSeparado($materials, 'reference_id', 'Referencia' , $errors, $ot ,'form-control material1',true,true) !!}
						<!--                                Cambiar valores -->


					</div>

                    {{-- <div id="col-referencia2" class="col-6 hidden">

                        {!! armarSelectArrayCreateEditOTSeparado($materials2, 'reference_id', 'Referencia' , $errors, $ot ,'form-control material2',true,true) !!}
                    </div> --}}
	...
	<div id="ot-caracteristicas" class="col-12 mb-2">
		<div class="card h-100">
			...
			<div class="card-header">6.- Características </div>
				...
				<div class="row">
					<div class="col-4">
						...
						{{-- <div class="" id="cad_input_container">
							{!! armarInputCreateEditOT('cad', 'CAD:', 'text',$errors, null, 'form-control', '', '') !!}
						</div>
						<div class="" id="cad_select_container" style="display:none">
							{!! armarSelectArrayCreateEditOT($cads, 'cad_id', 'CAD' , $errors, null ,'form-control form-element',true,true) !!}
						</div> --}}
                        <div class="form-group form-row">
							<div class="col-11">
						<div class="" id="cad_input_container">
						...
						<!-- PAÍS REFERENCIA -->
						{!! armarSelectArrayCreateEditOT($paisReferencia, 'pais_id', 'País referencia' , $errors, $ot ,'form-control',true,true) !!}
					...
					<div class="col-4">
						...
						<div class="form-group form-row">
							<div class="col-11">
								{!! armarInputCreateEditOT('caracteristicas_adicionales', 'Caracteristicas Estilo:', 'text',$errors, $ot, 'form-control', '', '') !!}
							</div>
	...
	<div id="ot-colores" class="col-12 mb-2">
		<div class="card h-100">
			<div class="card-header">7.- Color-Cera-Barniz</div>
				...
				<div class="row">
					...
					<div class="col-3">
						...
						{!! armarSelectArrayCreateEditOT([
								2 => "Flexografía",
								3 => "Flexografía Alta Gráfica",
								4 => "Flexografía Tiro y Retiro",
								5 => "Sin Impresión",
								// 6 => "Sin Impresión (Sólo OF)",
								// 7 => "Sin Impresión (Trazabilidad Completa)",
							], 'impresion', 'Impresión <i class="fas fa-info-circle"  title=" Para Cartón con Alta Gráfica, solo se muestra opción Flexografía Alta Gráfica" data-toggle="tooltip" data-original-title="Para Cartón con Alta Gráfica, solo se muestra opción Flexografía Alta Gráfica"></i>' , $errors, $ot ,'form-control',true,false,"185px") !!}

                            {!! armarSelectArrayCreateEditOT($trazabilidad, 'trazabilidad', 'Trazabilidad', $errors, $ot ,'form-control form-element',true,true) !!}


						<!-- TIPO Diseno -->
						{!! armarSelectArrayCreateEditOT($designTypes, 'design_type_id', 'Tipo Diseño', $errors, $ot ,'form-control',true,false,"200px") !!}

						<!-- Complejidad -->
						{!! armarInputCreateEditOT('complejidad', 'Complejidad', 'text',$errors, $ot, 'form-control', '', '') !!}

						<!-- Numero Colores-->
						{!! armarSelectArrayCreateEditOT([0,1,2,3,4,5,6], 'numero_colores', 'Número Colores' , $errors, $ot ,'form-control',true,true) !!}

						<!-- Recubrimiento Interno -->
						{!! armarSelectArrayCreateEditOT($coverageInternal, 'coverage_internal_id', 'Recubrimiento Interno:' , $errors, $ot ,'form-control',true,false,"127px") !!}

						<!-- % Recubrimiento Interno -->
						{!! armarInputCreateEditOT('percentage_coverage_internal', '% Recubrimiento Interno:', 'number',$errors, $ot, 'form-control', 'min="0"', '') !!}

						<!-- Recubrimiento Externo -->
						{!! armarSelectArrayCreateEditOT($coverageExternal, 'coverage_external_id', 'Recubrimiento Externo:' , $errors, $ot ,'form-control',true,false,"126px") !!}
					...
					<div class="col-3">
        				...
        				<!-- Barniz UV -->
						{{-- armarSelectArrayCreateEditOT([1 => "Si", 0=>"No"], 'barniz_uv', 'Barniz UV' , $errors, $ot ,'form-control',true,false) !!}
						<!-- % Barniz UV -->
						{!! armarInputCreateEditOT('porcentanje_barniz_uv', '% Impresión B. UV:', 'number',$errors, $ot, 'form-control', '', '') !!}
						--}}
	...
	<div id="ot-medidas-interiores" class="col-4 mb-2">
		<div class="card h-100">
			<div class="card-header">8.- Medidas Interiores</div>
			<div class="card-body form-row">
				<div class="col-4">
					{!! armarInputCreateEditOT('interno_largo', 'Largo (mm):', 'text',$errors, $ot, 'form-control', 'min="0"', '') !!}
				</div>
				<div class="col-4">
	...
	<div id="ot-medidas-exteriores" class="col-4 mb-2">
		<div class="card h-100">
			<div class="card-header">9.- Medidas Exteriores</div>
			<div class="card-body form-row">
				<div class="col-4">
	...
	<div id="ot-secuencia-operacional" class="col-4 mb-2" >
		<div class="card h-100">
			<div class="card-header">Secuencia Operacional</div>
			<div class="card-body form-row form-sec-operacional">
				<div class="col-4">
					{!! armarSelectArrayCreateEditOT($secuenciaOperacional, 'sec_operacional_principal', 'Planta Original' , $errors, $ot ,'form-control',true,true) !!}
				</div>
				<div class="col-4">
					{!! armarSelectArrayCreateEditOT($secuenciaOperacional, 'sec_operacional_1', 'Planta Alt. 1' , $errors, $ot ,'form-control',true,true) !!}
				</div>
				<div class="col-4">
					{!! armarSelectArrayCreateEditOT($secuenciaOperacional, 'sec_operacional_2', 'Planta Alt. 2' , $errors, $ot ,'form-control',true,true) !!}
				</div>
			</div>
		</div>
	</div>--}}
	...
	<div id="ot-terminaciones" class="col-4 mb-2">
		<div class="card h-100">
			<div class="card-header">10.- Terminaciones</div>
			<div class="card-body form-row">
				<div class="col-4">
					<!-- Proceso -->
	...
	<div id="ot-material" class="col-12 mb-2">
		<div class="card h-100">
			<div class="card-header">11.- Material Asignado</div>
			<div class="card-body">
	...
	<div id="ot-desarrollo" class="col-6 mb-2" >
		<div class="card h-100">
			<div class="card-header">12.- Datos para desarrollo</div>
			<div class="card-body">
				<div class="form-row">
					<div class="col-6">
						<!-- Tipo Producto -->
	...
	<div id="ot-sentido-onda" class="col-6 mb-2">
		<div class="card h-100">
			<div class="card-header">13.- Observación del trabajo a realizar</div>
			<div class="card-body">
				<div class="form-group form-row">
					<div class="col">
						<textarea class="{{$errors->has('observacion') ? 'error' : ''}}" style="resize: none;border-color:#3aaa35" name="observacion" id="observacion" cols="85" rows="12">@if(old('observacion')) {{old('observacion')}} @elseif(isset($ot->observacion) && !old('_token') && $tipo=='edit') {{ $ot->observacion}} @endif </textarea>
					</div>
				</div>
			</div>
		</div>
...
<input type="hidden" id="ot_origen" name="ot_origen" value="{{$ot->id}}">
<input type="hidden" id="operacion" name="operacion" value="duplicar">
