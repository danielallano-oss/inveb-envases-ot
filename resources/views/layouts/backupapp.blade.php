                ...
                <ul>
                    ...
                    <li class="dropmenu {{ request()->is('mantenedores/*') ? 'active' : '' }}">Mantenedores
                        <ul>
                            ...
                            <li><a href="{{ route('mantenedores.hierarchies.list') }}">Jerarquías</a></li>
                            <li><a href="{{ route('mantenedores.subhierarchies.list') }}">Subjerarquías</a></li>
                            ...
                            <li><a href="{{ route('mantenedores.materials.list') }}">Materiales</a></li>
                        </ul>
                    </li>
                </ul>
