...
<div class="container-fluid">
  <h1 class="page-title">Diseñador Externo Ajuste</h1>
</div>
...
{{-- Filtro de búsqueda --}}
<div class="container-fluid">
  <form id="filtroReporte" class="filter-form py-1" action="{{ route('reportTiempoDisenadorExternoAjuste') }}" method="get" enctype="multipart/form-data">
    <div class="form-row">
      <div class="col-2">
...
<div class="container-report">
  <div class="item-report  col-12" style="height: auto;">
    <h5 class="header-report">Detalle tiempos OT por Diseñador Externo - Ajuste</h5>
    <br>
    <table class="table">    
