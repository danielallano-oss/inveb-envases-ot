...
<div class="container-fluid">
  <h1 class="page-title">Tiempo Primera Muestra &nbsp;<div class="text-right">
      ...
      <script>
        function downloadFile() {
          ...
          link.href = '/docs/Info_Reporte_Tiempo_Primera_Muestra.pdf'; // Replace with the actual file path
          link.download = 'Info_Reporte_Tiempo_Primera_Muestra.pdf'; // Replace with the desired file name
...
{{-- Filtro de búsqueda --}}
<div class="container-fluid">
  <form id="filtroReporte" class="filter-form py-1" action="{{ route('reportTiempoPrimeraMuestra') }}" method="get" enctype="multipart/form-data">
    <div class="form-row">
      <div class="col-2">
