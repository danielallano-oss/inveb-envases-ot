...
<form class="loginForm" method="POST" action="{{ route('login') }}" id="filterForm">
    ...
    <div class="form-group">
        ...
        <input id="rut" type="text" class=" @error('rut') is-invalid @enderror" name="rut" value="{{ old('rut') }}" required autofocus>
    ...
    <span class="" role="alert" style="color: red; text-align: center;">
        ...
        <br><br>
        <div class="form-group">
            <a href="{{ route('recoveryPassword') }}" style="color: white;"> <label style="font-weight: 700">Restablecer Contraseña</label></a>
        </div>
    </span>
    @enderror
