...
<form class="loginForm" method="GET" action="{{ route('login') }}" id="filterForm">
    <div class="logoLogin">
    ...
    <div id="mensaje_reset"  style="color: white; text-align: center;">
        <span class=""  role="alert" style="color: white; text-align: center;">
            <strong>El correo para restablecer contraseña se encuentra expirado. Debe seleccionar la opcion nuevamente.</strong>
        </span>
    </div>
