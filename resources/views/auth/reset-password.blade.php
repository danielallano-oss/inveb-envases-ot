...
<form class="loginForm" method="POST" action="{{ route('resetPasswordStore') }}" id="filterForm">
    <div class="logoLogin">
    ...
    <div class="form-group"> 
        <label style="font-weight: 700">Su contraseña ha vencido</label>
    </div>

    <div class="form-group">
        <label style="font-weight: 700">Nueva Contraseña&nbsp;&nbsp;<span data-attribute="titulo" ><i class="fa fa-question-circle" title="{{$requisitos}}"></i></span></label>
    ...
    <div class="form-group">
        <label style="font-weight: 700">Confirmar Nueva Contraseña</label>
        <input id="password_confirm" type="password" class=" @error('password') is-invalid @enderror" name="password_confirm" required >
    ...
    @enderror
    <input type="hidden" id="token_reset" name="token_reset" value="{{$rut}}">
