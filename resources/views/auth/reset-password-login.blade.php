...
<form class="loginForm" method="POST" action="{{ route('login') }}" id="filterForm">
    <div class="logoLogin">
    ...
    <div class="form-group">
        <label style="font-weight: 700">{{ __('RUT') }}</label>
        <input id="rut" type="text" class=" @error('rut') is-invalid @enderror" name="rut" value="{{ $rut }}" required autofocus>
    ...
    <div class="form-group">
        <label style="font-weight: 700">{{ __('Password') }}</label>
    ...
    @enderror
        ...
        <div id="mensaje_reset"  style="color: white; text-align: center;">
            <span class=""  role="alert" style="color: white; text-align: center;">
                <strong>La contraseña fue actualizada correctamente</strong>
            </span>
        </div>
   
    <button type="submit" class="sbtn submit" style="cursor:pointer;" id="boton_ingresar">
        {{ __('Ingresar') }}
    </button>
