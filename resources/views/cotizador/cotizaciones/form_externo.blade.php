      ...
      <div class="card-body">
        <div class="row">
          <div class="col-3">
            ...
            @else
              {!! armarSelectArrayCreateEditOTEdipac([1=>"USD",2=>"CLP"], 'moneda_id', 'Moneda' , $errors, 2 ,'form-control form-element',true,true) !!}
            @endif
          </div>
          ...
          <div class="col-3">
            ...
            @else
              {!! armarSelectArrayCreateEditOTEdipac($dias_financiamiento, 'dias_pago', 'Días Pago' , $errors, 30 ,'form-control form-element',true,true) !!}
            @endif
          </div>
...
<div class=" mt-5 text-right componente-pasos-boton">
  <a href="{{ route('cotizador.index_cotizacion_externo') }}" class="btn btn-light">Cancelar</a>
...
<div id="contenedor-resultados" style="display: none;">
  ...
  <div class="text-center">
    ...
    <a href="{{ route('cotizador.retomarCotizacionExterno', $cotizacion->id) }}" onclick="event.preventDefault();
                        $('#retomarCotizacionForm').submit();" class="btn btn-success">Retomar Cotización</a>
  </div>
  @elseif( $cotizacion->estado_id == 6)
  <div class="text-center">
    <h5>Retomar Cotizacion Por Rechazo</h5>
