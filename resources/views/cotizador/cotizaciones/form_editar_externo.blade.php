...
<input type="hidden" name="tipo_gestion" id="tipo_gestion" value="{{isset($tipo) ? $tipo: ''}}">
<div class="form-row">
...
<div class=" mt-5 text-right componente-pasos-boton">
  ...
  <button data-toggle="tooltip" title="Si ha editado o agregado un detalle recuerde Actualizar resultados" id="generarPrecotizacionExterno" type="submit" class="btn btn-success float-right">{{ isset($cotizacion->id) ? __('Actualizar Pre-Cotización') : __('Generar Pre-Cotización') }}</button>
...
<div id="contenedor-resultados" style="display: none;">
  ...
  <div class="text-center">
    ...
    <a href="{{ route('cotizador.retomarCotizacionForm', $cotizacion->id) }}" onclick="event.preventDefault();
