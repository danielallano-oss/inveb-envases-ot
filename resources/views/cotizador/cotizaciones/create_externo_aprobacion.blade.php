...
<div class="row mb-3">
  <div class="col-12 p-2">
    <form id="formCotizacion" method="POST" action="{{ route('cotizador.crear_areahc') }}">
      @csrf
      @include('cotizador.cotizaciones.form_editar_externo', ['tipo' => "create",'cotizacion' => $cotizacion,'class' => '',])
    </form>
...
<script src="{{ asset('js/cotizador/detalle-cotizacion-externo-aprobacion.js?'.date('ymdhis'))}}"></script>
