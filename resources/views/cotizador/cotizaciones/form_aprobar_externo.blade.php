...
<div id="contenedor-resultados" style="display: none;">
  ...
  @endif
  <div class="text-center">
    <h5>Editar Cotizacion </h5>

    <a href="{{ route('cotizador.editarCotizacionExterno', $cotizacion->id) }}" onclick="event.preventDefault();
                        $('#editarCotizacionForm').submit();" class="btn btn-success">Editar Cotización</a>
  </div>
</div>
