...
<div class="row">
  <div class="col-12">
    <div class="page-title" style="display:inline">Carga masiva de Matrices

    </div>
    <!-- <a class="btn btn-success btn-sm" data-attribute="link" href="/files/Carga Masiva Corrugados.xlsx" download title="Descargar">Archivo Ejemplo matrices</a> -->
    <a class="btn btn-info flot-right" href="{{ route('mantenedores.matrices.descargar_excel_matrices') }}" title="Descargar Listado matrices">Descargar Listado Matrices
      <div class="material-icons md-14" data-toggle="tooltip" title="Descargar Listado matrices" style="color:white;">download</div> </a>
    </a>
  </div>
</div>
<br>
<div class="normalForm">
  <!-- formulario: -->
  <form id="form-carga-matrices" method="POST" enctype="multipart/form-data" action="{{ route('mantenedores.matrices.uploading') }}">
    @csrf
    <div class="col-xs-12 col-md-12">
      <div class="row">
        <div id="container-boton-carga" class="col-2 row text-center">
          ...
          <div class="col-12">
            <button id="btn-cargar-matrices" disabled type="submit" class="btn btn-success ">Procesar Matrices</button>
          </div>
...
<div class="row ">
  <div class="col">
    <div class="card-counter primary">
      ...
      <span id="totalmatrices" class="count-numbers">{{$matrices->count()}}</span>
      <span class="count-name">Total Matrices</span>
    </div>
  </div>
  <div class="col">
    <div class="card-counter success">
      <div class="material-icons md-70" data-toggle="tooltip" style="color:white;font-size:50px">add</div>
      <span id="matricesNuevos" class="count-numbers">0</span>
      <span class="count-name">Matrices Nuevos</span>
    </div>
  </div>
  <div class="col">
    <div class="card-counter warning">
      <div class="material-icons md-70" data-toggle="tooltip" style="color:white;font-size:50px;color:#000">edit</div>
      <span id="matricesActualizados" class="count-numbers">0</span>
      <span class="count-name">Matrices Actualizados</span>
    </div>
  </div>
  <div class="col">
    <div class="card-counter danger">
      <div class="material-icons md-70" data-toggle="tooltip" style="color:white;font-size:50px">clear</div>
      <span id="matricesInactivados" class="count-numbers">0</span>
      <span class="count-name">Matrices Inactivados</span>
    </div>
  </div>
  <div class="col">
    <div class="card-counter " style="background-color: #eac7c7;">
      ...
      <span id="matricesErroneos" class="count-numbers">0</span>
  ...
  <div class="col-12 ">
    <div class="" style="margin: 5px;;background-color: #f2f4f5;height: 40px;border-radius: 5px;">
      <ul class="legend" style="display: flex;justify-content:space-around">
        <li data-toggle="tooltip" data-html="true" title="Total matrices"><span style="background-color:#4491e4"></span> Total Matrices</li>
        <li data-toggle="tooltip" data-html="true" title="matrices Nuevos"><span style="background-color:#66bb6a"></span> Matrices Nuevos</li>
        <li data-toggle="tooltip" data-html="true" title="matrices Actualizados"><span style="background-color:#faffa8"></span> Matrices Actualizados</li>
        <li data-toggle="tooltip" data-html="true" title="matrices Inactivados"><span style="background-color:#ef5350"></span> Matrices Inactivados</li>
...
<div class="container-table mt-3 bg-white border px-2">
  <table id="listadomatricesMasivos" class="table table-status table-hover text-center">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr id="matriz-row-{{ $matriz->orden }}" class="{{ $matriz->active == 1 ? '' : 'text-muted' }}">
        <td>{{ $matriz->id }}</td>
        ...
        <td>{{ $matriz->cuchillas }}</td>
        <td>{{ $matriz->maquina }}</td>
        <td>
          @if($matriz->active == 1) Activo
          @else Inactivo
          @endif
        </td>
      </tr>
...
<button onclick="topFunction()" id="myBtn" title="Go to top">
  <div class="material-icons md-18" data-toggle="tooltip" title="Descargar Listado matrices" style="color:white;">arrow_upward</div> </a>
</button>
...
<script src="{{ asset('js/mantenedores/matrices-masivo.js') }}"></script>
@endsection
