...
<head>
    <meta charset="utf-8">
    <title>Actualización Matriz</title>
    <style>
        a:hover,
        a {
            /* color: #267023; */
    ...
    <table style="width:100%;">
        <tbody style="text-align: center;font-family: Arial!important">
            ...
            <tr>
                ...
                Actualizar la base datos matrices al {{ $data->fecha }}
                </td>
            </tr>
            <tr>
                <td style="padding: 50px 30px;line-height: 2; text-align:left; color: black; font-size: 14px;">
                    <p>Hoy es viernes {{$data->fecha}}, recuerde que debe actualizar la base datos matrices, en el mantenedor del sistema.</p>
                    <!-- <br> -->
