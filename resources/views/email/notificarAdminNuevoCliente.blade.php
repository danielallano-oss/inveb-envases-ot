        ...
        <tbody style="text-align: center;font-family: Arial!important">
            ...
            <tr>
                <td style="padding: 50px 30px;line-height: 2; text-align:left; color: black; font-size: 14px;">
                    <p>Estimado/a <b>Administrador</b>, le notificamos que se ha registrado a <strong>{{$data->nombre}}</strong> como nuevo cliente de Clasificación Z por defecto, por lo cual le sugerimos que ingrese al sistema para su pronta gestión.</p>
                    <!-- <br> -->
                    <div class="container" style="text-align: center;">
                        <a class="btn btn-success" style="font-size: 14px;" href="https://envases-ot.inveb.cl/mantenedores/clients/editar/{{$data->id}}"><strong>Gestionar Clientes</strong></a>
                    </div>
