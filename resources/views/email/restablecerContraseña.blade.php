        ...
        <tbody style="text-align: center;font-family: Arial!important">
            ...
            <tr>
                <td style="padding: 50px 30px;line-height: 2; text-align:left; color: black; font-size: 14px;">
                    <p>Estimado/a usuario presionando el siguiente boton podrá ingresar a la opción para restablecer su contraseña
                    <!-- <br> -->
                    <div class="container" style="text-align: center;">
                        <a class="btn btn-success" style="font-size: 14px;" href="https://envases-ot.inveb.cl/resetPasswordRecovery?token={{$token}}"><strong>Restablecer Contraseña</strong></a>
                    </div>
