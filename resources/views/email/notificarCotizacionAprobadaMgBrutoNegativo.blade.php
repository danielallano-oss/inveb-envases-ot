...
<head>
    <meta charset="utf-8">
    <title>Cotizacion Aprobada con Margen Bruto Negativo</title>
    <style>
        a:hover,
        a {
            /* color: #267023; */
        ...
        <tbody style="text-align: center;font-family: Arial!important">
            ...
            <tr>
                <td style="color: #3aaa35;font-size: 20px;font-weight: bold;padding: 20px;">
                    NOTIFICACIÓN DE COTIZACION APROBADA CON MARGEN BRUTO NEGATIVO
                </td>
            </tr>
            <tr>
                <td style="padding: 50px 30px;line-height: 2; text-align:left; color: black; font-size: 14px;">
                    <!-- <br> -->
                    <p>Estimado/a, se informa que la cotización número <b>{{$data}}</b> ha sido aprobada, sin embargo, el margen bruto es negativo.</p>
