...
@endif
@if(isset($cotizacion) && auth()->user()->id != $cotizacion->user_id )
...
<div id="aprobar-form" class="collapse">
    <div class="card mt-3">
        <div class="card-body">
            <form id="aprobacion-cotizacion" method="POST" action="{{ route('cotizador.gestionar-cotizacion-externo', $cotizacion->id) }}" enctype="multipart/form-data">
                @csrf
...
<div id="rechazo-form" class="collapse">
    <div class="card mt-3">
        <div class="card-body">
            <form id="rechazo-cotizacion" method="POST" action="{{ route('cotizador.gestionar-cotizacion-externo', $cotizacion->id) }}" enctype="multipart/form-data">
                @csrf
